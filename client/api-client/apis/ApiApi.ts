...
export class ApiApi extends runtime.BaseAPI {
     ...
     */
    async obtainTokenAsDemoApiTokenAsDemoPostRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenPair>> {
        const requestOptions = await this.obtainTokenAsDemoApiTokenAsDemoPostRequestOpts();
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Obtain Token As Demo
     */
    async obtainTokenAsDemoApiTokenAsDemoPost(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TokenPair> {
        const response = await this.obtainTokenAsDemoApiTokenAsDemoPostRaw(initOverrides);
        return await response.value();
    }
