            ...
            {projects.map((project) => (
              <li key={project.id}>
                <div className="group flex items-center gap-1 transition-colors hover:bg-base-200">
                  <span
                    className="drag-handle ml-1 grid size-8 shrink-0 place-items-center rounded-md text-base-content/30 sm:ml-2"
                    aria-hidden="true"
                  >
                    <svg
                      className="size-4"
      ...
      {open && (
        ...
        >
          ...
          <input
            ...
            required
          />
          <div className="flex items-center justify-end gap-2 border-t border-base-300 px-3 py-2">
            <button
              type="button"
