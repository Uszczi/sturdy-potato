...
// Where the authenticated session (JWT in localStorage) is persisted by
// e2e/global-setup.ts and reused by every test project (see storageState in
